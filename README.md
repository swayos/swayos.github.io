...
Download the latest installer ISO from [releases](https://github.com/milgra/swayos/releases), burn it to a pendrive/etc and start your machine up with it. Installer will start automagically.
